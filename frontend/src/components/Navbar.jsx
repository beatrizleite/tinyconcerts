                        ...
                        <div className='absolute right-0 top-12 bg-gray-800 !text-white rounded-md shadow-lg w-48'>
                            <ul className='p-2'>
                                {isLoggedIn ? (
                                    ...
                                    <>
                                        <li className='px-4 py-2 hover:bg-red-500 rounded-md cursor-pointer'>Login</li>
                                        <li className='px-4 py-2 hover:bg-red-500 rounded-md cursor-pointer'>Sign Up</li>
                                    </>
                                )}
                            </ul>
                        </div>
